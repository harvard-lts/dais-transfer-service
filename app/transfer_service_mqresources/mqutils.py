...
def get_transfer_mq_connection(queue=None):
    logger.debug("************************ MQUTILS - GET_TRANSFER_MQ_CONNECTION *******************************")
    try:
...
def notify_transfer_status_message(transfer_status, queue=None):
    ...
    logger.debug("************************ MQUTILS - NOTIFY_TRANSFER_STATUS_MESSAGE *******************************")
    ...
    logger.debug("MESSAGE TO QUEUE notify_transfer_status_message")
